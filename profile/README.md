...
| [yellow-hammer/prometheus-e1c](https://github.com/yellow-hammer/prometheus-e1c) | Расширение 1С:Предприятие 8 для экспорта метрик в ... | 10 | 1C Enterprise |
| [infina15/oproxy](https://github.com/infina15/oproxy) | TCP прокси-сервер хранилища конфигураций 1С | 72 | 1C Enterprise |
| [vanessa-opensource/vanessa-runner](https://github.com/vanessa-opensource/vanessa-runner) | утилита автоматизации базовых операций разработчик... | 244 | 1C Enterprise |
| [zerobig/vscode-1c-metadata-viewer](https://github.com/zerobig/vscode-1c-metadata-viewer) | Вывод дерева метаданных конфигурации 1С и открытие... | 242 | TypeScript |
| [cpr1c/tools_ui_1c](https://github.com/cpr1c/tools_ui_1c) | Универсальные инструменты 1С для управляемых форм | 996 | 1C Enterprise |
| [yellow-hammer/mcp-1c-platform-tools](https://github.com/yellow-hammer/mcp-1c-platform-tools) | MCP-сервер расширения 1C: Platform Tools для агент... | 14 | TypeScript |
| [zerobig/swagger-1c](https://github.com/zerobig/swagger-1c) | Документация HTTP сервисов в 1С при помощи swagger | 106 | 1C Enterprise |
...
| [firstBitMarksistskaya/jenkins-lib](https://github.com/firstBitMarksistskaya/jenkins-lib) | Jenkins shared library для 1С:Предприятие 8 | 202 | Groovy |
...
| [1c-syntax/1c-syntax](https://github.com/1c-syntax/1c-syntax) | Syntax definition rules for 1C:Enterprise 8 in Tex... | 132 | 1C Enterprise |
...
| [devicons/devicon](https://github.com/devicons/devicon) | Set of icons representing programming languages, d... | 11541 | CSS |
| [EclipseFdn/open-vsx.org](https://github.com/EclipseFdn/open-vsx.org) | Source of open-vsx.org | 312 | TypeScript |
...
| [vanessa-opensource/add](https://github.com/vanessa-opensource/add) | Разработка с управляемым качеством на 1С | 363 | 1C Enterprise |
...
| [yellow-hammer/vanessa-bootstrap](https://github.com/yellow-hammer/vanessa-bootstrap) | Шаблон правильной разработки на платформе 1С: Пред... | 13 | 1C Enterprise |
